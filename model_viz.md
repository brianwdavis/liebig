...
This generates all the possible frontiers derived from our coefficient estimates. You can see that they're mostly clustered along one path, with some faint outliers as you move away (variance in &gamma;<sub>0</sub>), and that there's wiggle toward the ends as variance in the slope (&gamma;<sub>1</sub>) gets magnified.
